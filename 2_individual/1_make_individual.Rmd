...
```{r get_param}
sample_name = params$sample_name # "GSM5050721"
# sample_name = "GSM5050721"
```
...
```{r cell_markers}
cell_markers = readRDS(paste0(out_dir, "/../1_metadata/patients_cell_markers.rds"))
...
```{r dotplot_markers}
dotplot_markers = readRDS(paste0(out_dir, "/../1_metadata/patients_dotplot_markers.rds"))
